...
import static seedu.address.logic.commands.CommandTestUtil.HOMEPAGE_DESC_AMY;
import static seedu.address.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static seedu.address.logic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
import static seedu.address.logic.commands.CommandTestUtil.INVALID_HOMEPAGE_DESC;
...
public class EditCommandParserTest {
    ...
    private static final String HOMEPAGE_EMPTY = " " + PREFIX_HOMEPAGE;
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND + HOMEPAGE_DESC_AMY;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withHomepage(VALID_HOMEPAGE_AMY).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).build();
