...
public class CommandTestUtil {
    ...
    public static final String VALID_HOMEPAGE_AMY = "http://www.google.com";
    public static final String VALID_HOMEPAGE_BOB = "http://www.facebook.com";
    public static final String VALID_ADDRESS_AMY = "Block 312, Amy Street 1";
    public static final String VALID_ADDRESS_BOB = "Block 123, Bobby Street 3";
    public static final String VALID_BIRTHDAY_AMY = "01/01/2001";
    public static final String VALID_BIRTHDAY_BOB = "02/02/2002";
    public static final String VALID_TAG_HUSBAND = "husband";
    public static final String VALID_TAG_FRIEND = "friend";
    public static final String VALID_REMARK_AMY = "family";
    public static final String VALID_REMARK_BOB = "friends";
    ...
    public static final String HOMEPAGE_DESC_AMY = " " + PREFIX_HOMEPAGE + VALID_HOMEPAGE_AMY;
    public static final String HOMEPAGE_DESC_BOB = " " + PREFIX_HOMEPAGE + VALID_HOMEPAGE_BOB;
    ...
    public static final String INVALID_BIRTHDAY_DESC = " " + PREFIX_BIRTHDAY
            + "11/11/111"; // year field needs to be 4 numbers
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withBirthday(VALID_BIRTHDAY_AMY).withTags(VALID_TAG_FRIEND).withHomepage(VALID_HOMEPAGE_AMY).build();
