    ...
    public FindCommand parse(String args) throws ParseException {
        ...
        try {
            if (arePrefixesPresent(argMultimap, PREFIX_ADDRESS)) {
                ...
                return new FindCommand(new personContainsKeywordsPredicate(FindCommand.COMMAND_WORD_ADDRESS, keywordsList));
            }
                ...
                return new FindCommand(new personContainsKeywordsPredicate(FindCommand.COMMAND_WORD_EMAIL, keywordsList));
            }
                ...
                return new FindCommand(new personContainsKeywordsPredicate(FindCommand.COMMAND_WORD_HOMEPAGE, keywordsList));
            }
                ...
                return new FindCommand(new personContainsKeywordsPredicate(FindCommand.COMMAND_WORD_PHONE, keywordsList));
            }
                ...
                return new FindCommand(new personContainsKeywordsPredicate(FindCommand.COMMAND_WORD_TAG, keywordsList));
            }
                ...
                return new FindCommand(new personContainsKeywordsPredicate(FindCommand.COMMAND_WORD, Arrays.asList(keywords)));
            }
            else{
