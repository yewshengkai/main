...
|`* * *` |user |find a person by exact matching details of a person|locate details matching exactly specified details of all persons without going through the entire list

|`* * *` |user |find a person by any matching details of a person |locate details matching any specified details of all persons without going through the entire list
...
|`* *` |user |search my contacts with other information other than name |find contacts just by knowing other information
...
1.  User request to list contacts.
2.  AddressBook shows a list of contacts.
3.  User request and find a contact.
4.  AddressBook list the contact.
+
Use case ends.
