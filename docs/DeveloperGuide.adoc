...
|`* * *` | user |be able to set the homepage for a contact | able to customize the details of the contact

|`* * *` |user |tag contacts |I can find people with the same tags easily in a listing
...
|`* *` |user with many frequently used contacts |mark specific contacts as a "Favourite" |find my favourite contacts
easily
...
|`*` |user with many persons in the address book |have autocomplete search in the find command |locate a contact
