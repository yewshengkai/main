...
*Alternative 1 (Current choice):* Utilizes event handler to call and ensure the web browser won't be obstruct by `PersonSideCard` panel with another event handler that controls the visibility. +
