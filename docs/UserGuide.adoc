...
`find [p/PHONE] KEYWORD [MORE_KEYWORDS]` +
`find [e/EMAIL] KEYWORD [MORE_KEYWORDS]` +
`find [a/ADDRESS] KEYWORD [MORE_KEYWORDS]` +
`find [h/HOMEPAGE] KEYWORD [MORE_KEYWORDS]` +
`find [t/TAG] KEYWORD [MORE_KEYWORDS]`
...
Format: +
`findany KEYWORD [MORE_KEYWORDS]` +
`findany [p/PHONE] KEYWORD [MORE_KEYWORDS]` +
`findany [e/EMAIL] KEYWORD [MORE_KEYWORDS]` +
`findany [a/ADDRESS] KEYWORD [MORE_KEYWORDS]` +
`findany [h/HOMEPAGE] KEYWORD [MORE_KEYWORDS]` +
`findany [t/TAG] KEYWORD [MORE_KEYWORDS]`
